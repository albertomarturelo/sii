...
// JSON is the DEFAULT output: the CLI is a faithful façade over the @albertomarturelo/sii-core library
...
/** Exit-code contract (see @albertomarturelo/sii-core errors.ts): NotAuthenticated → 2 (incl.
